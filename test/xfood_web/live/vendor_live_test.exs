defmodule XfoodWeb.VendorLiveTest do
  ...
  @create_attrs %{block: "some block", status: "some status", permit: "some permit", location: "some location", approved: "some approved", y: 120.5, x: 120.5, location_id: 42, applicant: "some applicant", facility_type: "some facility_type", cnn: 42, location_description: "some location_description", andress: "some andress", blocklot: "some blocklot", lot: "some lot", food_items: "some food_items", latitud: 120.5, longitude: 120.5, schedule: "some schedule", days_hours: "some days_hours", noi_sent: "some noi_sent", received: "2024-06-07T12:43:00", prior_permit: true, expiration_date: "2024-06-07T12:43:00", fire_prevention_districts: 42, police_districts: 42, supervisor_districts: 42, zip_codes: "some zip_codes", old_neighborhoods: 42}
  @update_attrs %{block: "some updated block", status: "some updated status", permit: "some updated permit", location: "some updated location", approved: "some updated approved", y: 456.7, x: 456.7, location_id: 43, applicant: "some updated applicant", facility_type: "some updated facility_type", cnn: 43, location_description: "some updated location_description", andress: "some updated andress", blocklot: "some updated blocklot", lot: "some updated lot", food_items: "some updated food_items", latitud: 456.7, longitude: 456.7, schedule: "some updated schedule", days_hours: "some updated days_hours", noi_sent: "some updated noi_sent", received: "2024-06-08T12:43:00", prior_permit: false, expiration_date: "2024-06-08T12:43:00", fire_prevention_districts: 43, police_districts: 43, supervisor_districts: 43, zip_codes: "some updated zip_codes", old_neighborhoods: 43}
  @invalid_attrs %{block: nil, status: nil, permit: nil, location: nil, approved: nil, y: nil, x: nil, location_id: nil, applicant: nil, facility_type: nil, cnn: nil, location_description: nil, andress: nil, blocklot: nil, lot: nil, food_items: nil, latitud: nil, longitude: nil, schedule: nil, days_hours: nil, noi_sent: nil, received: nil, prior_permit: false, expiration_date: nil, fire_prevention_districts: nil, police_districts: nil, supervisor_districts: nil, zip_codes: nil, old_neighborhoods: nil}
